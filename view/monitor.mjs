...
export class MonitorView extends Backbone.View {
    initialize(args) {
        ...
        this._idle = null;
        this._removeButtonMarkup = '<vscode-button appearance="icon" name="remove" style="vertical-align: middle;"><i class="codicon codicon-close"></i></vscode-button>';
        this._baseSelectorMarkup = baseSelectMarkupHTML;
        this._bitTriggerMarkup = '<vscode-dropdown position="below" style="vertical-align: middle;" name="trigger" title="Trigger"><vscode-option value="none">none</vscode-option><vscode-option value="rising">↑</vscode-option><vscode-option value="falling">↓</vscode-option><vscode-option value="risefall">↕</vscode-option><vscode-option value="undef">x</vscode-option></vscode-dropdown>';
